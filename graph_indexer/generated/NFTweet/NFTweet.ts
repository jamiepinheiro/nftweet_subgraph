...
export class NFTweet extends ethereum.SmartContract {
  static bind(address: Address): NFTweet {
    return new NFTweet("NFTweet", address);
  }
  ...
  getDelegateHistory(): Array<Address> {
    let result = super.call(
      "getDelegateHistory",
      "getDelegateHistory():(address[])",
      []
    );
  ...
  try_getDelegateHistory(): ethereum.CallResult<Array<Address>> {
    let result = super.tryCall(
      "getDelegateHistory",
      "getDelegateHistory():(address[])",
      []
  ...
  isDelegate(delegate: Address): boolean {
    let result = super.call("isDelegate", "isDelegate(address):(bool)", [
  ...
  try_isDelegate(delegate: Address): ethereum.CallResult<boolean> {
    let result = super.tryCall("isDelegate", "isDelegate(address):(bool)", [
      ethereum.Value.fromAddress(delegate)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
